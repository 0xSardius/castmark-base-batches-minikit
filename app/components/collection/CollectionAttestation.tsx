...
import type { Abi } from "viem"; // or from your contract library

const ATTESTATION_CONTRACT = "0x1234000000000000000000000000000000000000"; // Replace with actual contract address
const ATTESTATION_ABI = [] as unknown as Abi; // Add appropriate ABI

interface CollectionAttestationProps {
  collection: Collection;
}

export function CollectionAttestation({
  collection,
